...
If you use this PHITS input file, model structure, or the included `usrresol.f` user routine, please cite this repository. Citation metadata is provided in `CITATION.cff`.
